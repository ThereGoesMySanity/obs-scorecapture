...
struct obs_source_info scorecapture_filter_info = {
	...
	.get_name = [](void *unused) { UNUSED_PARAMETER(unused); return obs_module_text("ScoreCapture"); },
	.create =
	...
	.video_render = [](void *data, gs_effect_t *effect) { static_cast<SCFilter *>(data)->videoRender(effect); }
};
}
